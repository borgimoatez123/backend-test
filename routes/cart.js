...
router.post('/decrement',verifyAndAuthorization, cartControlller.decrementProductQty)


router.delete('/delete/:id',verifyAndAuthorization, cartControlller.removeProductFromCart)
